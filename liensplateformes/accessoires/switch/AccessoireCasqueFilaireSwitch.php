...
<html>
	<head>
		...
		<title>Cube-Gaming - Casque Filaire Nintendo Switch</title>
	</head>
	...
	<body>
		<div id="bloc_page">
			...
			<section id="produit">
				...
				<div id="contenu">
					<div class="photo_detail_produit_accessoire">
						<img src="../../../images/accessoires/casque_filaire_switch.jpg" alt="Photo d'un accessoire Casque Filaire Switch">
					</div>
					<div class="presentation_detail_produit_accessoire">
						<h1>Casque Filaire Nintendo Switch</h1>
						...
						<div id="description_detail_produit_accessoire">
							<p>Casque filaire Nintendo Switch<a href="#LienLireLaSuite">Lire la suite</a></p>
						</div>
					</div>
				</div>
			</section>
			...
			<section>
				...
				<div class="contenu_detail_sup_produit_accessoire">
					<h3 id="details">Details sur le produit</h3>
					<p>- <strong>Date de parution :</strong> 16 Aout 2019 <br />
